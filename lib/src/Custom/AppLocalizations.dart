...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'es': {
      ...
      'dashboard_subtitle': 'Vista clara de riesgo, avance y plan de acción',
    ...
    'en': {
      ...
      'dashboard_title': 'Progress panel',
      'dashboard_subtitle': 'Clear view of risk, progress, and action plan',
